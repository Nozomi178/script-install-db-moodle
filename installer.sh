...
if [ "$OPTION" = "1" ]; then
    ...
    echo ""
    echo "Secure MariaDB Configuration"
...
EOF
    ...
    echo ""
    echo "Konfigurasi Database Moodle"
...
EOF
    ...
    echo ""
    echo "Database Server selesai dikonfigurasi."
fi
